...
public static String getStringData(int a,int b, String sheet) throws IOException // a is row ,b is column or cell
{
	...
	f=new FileInputStream("C:\\Users\\112ra\\git\\Automationcourse\\AutomationCourse\\src\\test\\resources\\Testdata.xlsx");//Copy as path - the file location where it is saved
...
public static String getIntegerData(int a,int b, String sheet) throws IOException { 
	f=new FileInputStream("C:\\Users\\112ra\\git\\Automationcourse\\AutomationCourse\\src\\test\\resources\\Testdata.xlsx");
